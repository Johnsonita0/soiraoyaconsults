...
export const seedContent = {
  ...
  servicesVersion: 2,
  services: [
    { title: 'Property & Asset Valuation', text: 'Independent valuations that give owners, lenders, and investors a clear basis for action.', icon: BarChart3 },
    ...
    { title: 'Facility Management', text: 'Practical oversight that protects facilities, improves performance, and supports reliable operations.', icon: Building2 },
    { title: 'Project Management', text: 'Structured coordination that moves property projects from planning through delivery.', icon: Building2 },
    { title: 'Real Estate Consultancy', text: 'Clear, commercially grounded advice for complex property decisions and opportunities.', icon: Leaf },
    { title: 'General Estate Agency', text: 'Professional support for buying, selling, letting, and positioning property in the market.', icon: Home },
    { title: 'Feasibility & Viability Appraisal', text: 'Evidence-led appraisals that test development potential, risks, and returns before commitment.', icon: BarChart3 },
  ],
  gallery: [
